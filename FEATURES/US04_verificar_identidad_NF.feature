...
Feature: Verificar identidad
  ...
  Scenario: Verificación exitosa
    ...
    When carga los siguientes documentos

      | Documento | Número   | Estado |
      | DNI       | 76543210 | Legible |
      | Selfie    | Foto     | Correcta |
  ...
  Scenario: Documento no válido
    Given el propietario carga la siguiente documentación
